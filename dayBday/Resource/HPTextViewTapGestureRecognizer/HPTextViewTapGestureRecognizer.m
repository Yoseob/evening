...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    {
        if([self.delegate respondsToSelector:@selector(gestureRecognizerNotthing)]){
        }
    ...
    attrString = [textView.attributedText attributedSubstringFromRange:_range];
    if (attrString)
    {
        return;
    }
...
//        if(attrString){
//            if([self.delegate respondsToSelector:@selector(gestureRecognizer:handleTapOnAttributeString:inRange:)]){
////                [self.delegate gestureRecognizer:self handleTapOnAttributeString:attrString inRange:_range];
////                 [self.delegate gestureRecognizerNotthing];
//            }
//        }
//        
    }
